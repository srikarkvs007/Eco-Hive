    ...
    return (
        <div className="d-flex flex-column align-items-center min-vh-100 pt-5" style={{ backgroundColor: 'var(--bg-color)' }}>
            ...
            <div className="container py-4" style={{ maxWidth: '800px' }}>
                <h1 className="fw-bolder mb-4 text-center" style={{ fontSize: '42px', color: 'var(--text-primary)' }}>Legal & Privacy</h1>
                
                <div className="card border-0 shadow-sm rounded-4 p-5 mb-4" style={{ backgroundColor: 'var(--bg-elevated)', border: 'var(--glass-border)' }}>
                    <h3 className="fw-bold mb-3" style={{ color: 'var(--text-primary)' }}>Conditions of Use</h3>
                    ...
                    <h3 className="fw-bold mb-3" style={{ color: 'var(--text-primary)' }}>Privacy Notice</h3>
                    <p className="text-muted mb-4" style={{ lineHeight: '1.8', fontSize: '16px' }}>
